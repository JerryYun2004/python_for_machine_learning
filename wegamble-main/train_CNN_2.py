...
Version: 2
Dataset: all
accuracy: 0.0476 - loss: 3.6894 - val_accuracy: 0.0472 - val_loss: 3.7119
Epoch: 40/50
Batch-size: 64
"""
...
if __name__ == "__main__":
    ...
    df2_train = pd.read_csv(r"C:\Users\zizhu\.ssh\ps_Project\stacked_cards_db\train_cards_label_translated.csv")
    df2_test = pd.read_csv(r"C:\Users\zizhu\.ssh\ps_Project\stacked_cards_db\test_cards_label_translated.csv")
    df3 = pd.read_csv(r"C:\Users\zizhu\.ssh\ps_Project\tree_cards_database\cards.csv")

    df3 = df3.rename(columns={"filename": "filename", "class": "class"})
    df3 = df3[["filename", "class"]]
    ...
    df2_train["root"] = r"C:\Users\zizhu\.ssh\ps_Project\stacked_cards_db\train_zipped"
    df2_test["root"] = r"C:\Users\zizhu\.ssh\ps_Project\stacked_cards_db\test_zipped"
    df3["root"] = r"C:\Users\zizhu\.ssh\ps_Project\tree_cards_database"

    df = pd.concat([df1, df2_train, df2_test, df3], ignore_index=True)
